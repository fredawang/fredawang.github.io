...
//      newWidth += this.handle.width() + 15; 
  ...
  initialPosition: function() {
  	this_container_width = 66;
  	this_handle_width = 23;
    this.offLabel.css({ width: this_container_width - 5 });
//  this.offLabel.css({ width: this.container.width() - 5 });

    var offset = ($.browser.msie && $.browser.version < 7) ? 3 : 6;
    this.rightSide = this_container_width - this_handle_width - offset;
